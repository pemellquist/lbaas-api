...
/**
 * <p>Java class for lbaasException complex type.
 * 
 * <p>The following schema fragment specifies the expected content contained within this class.
 * 
 * <pre>
 * &lt;complexType name="lbaasException">
 *   &lt;complexContent>
...
@XmlType(name = "lbaasException", propOrder = {
    "message",
    "details"
})
@XmlSeeAlso({
    OverLimit.class,
    LoadBalancerException.class,
    UnProcessableEntity.class,
    Unauthorized.class,
    BadRequest.class,
    ImmutableEntity.class,
    GeneralException.class,
    OutOfVirtualIps.class,
    ItemNotFound.class,
    ServiceUnavailable.class
})
public class LbaasException
